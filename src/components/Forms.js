        ...
        {success ? (
          <div className={styles.successState}>
            ...
            <p className={styles.successText}>
              ...
              {activeTab === "players" && "Your player inquiry has been submitted to the Iron Forest FC technical staff. We will reach out when pre-season tryout dates are announced."}
